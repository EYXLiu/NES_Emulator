...
void Bus::disassemble(uint16_t nStart, uint16_t nStop)
{
    std::map<uint16_t, std::string> res = cpu.disassemble(nStart, nStop);
...
void Bus::SetSampleFrequency(uint32_t sample_rate)
{
    ...
    dAudioTimePerNESClock = 1.0 / 1789773.0; //PPU Clock Frequency
}
